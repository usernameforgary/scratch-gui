...
const MODAL_SAVING_PROJECT = 'savingProject';
...
const openSavingProject = function() {
    return openModal(MODAL_SAVING_PROJECT)
}
...
const closeSavingProject = function() {
    return closeModal(MODAL_SAVING_PROJECT)
}
export {
    reducer as default,
